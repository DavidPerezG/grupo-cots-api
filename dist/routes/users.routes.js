...
router.post('/', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.verifyAdmin, _middlewares.verifySignup.checkRolesExisted, _middlewares.verifySignup.checkDuplicateEmail], usersController.createUser);
